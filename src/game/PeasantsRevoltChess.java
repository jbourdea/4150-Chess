...
/**
 * 
 * This is the class that represents the game mode of Peasants Revolt. The class contains the rules for validating moves and checking boardstate (e.g. check, checkmate, etc.).
 *
 */
